...
import com.ssuet.yousufminhaj.chatapptest2.ui.FriendsFragment;
import com.ssuet.yousufminhaj.chatapptest2.ui.GroupFragment;
import com.ssuet.yousufminhaj.chatapptest2.ui.LoginActivity;
import com.ssuet.yousufminhaj.chatapptest2.ui.UserProfileFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(toolbar != null) {
            ...
            getSupportActionBar().setTitle("STAPP");
        }
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "STAPP version 1.0 Created by Yousuf Minhaj on 10/8/2017. ", Toast.LENGTH_LONG).show();
            return true;
        }
